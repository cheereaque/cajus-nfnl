...
local function _2_()
  ...
  local http_snippets_folder = (icloud_path .. "/share/nvim/rest_nvim/dev")
  local find_http_snippet = (":lua require('telescope.builtin').find_files({ cwd = \"" .. http_snippets_folder .. "\"})<CR>")
