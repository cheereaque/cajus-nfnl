...
[{1 :Olical/conjure
  ...
  :init (fn []
          ...
          (set nvim.g.conjure#path_subs {"/root/.m2/" (.. (nvim.fn.getenv "HOME") "/.m2/")})
          ...
          (nvim.create_user_command
            ...
            #(set vim.g.clojure_enable_formatting false)
            {:bang true})

          (nvim.create_user_command
            :ClojureAutoReloadUser
            #(do
               (set nvim.g.conjure#client#clojure#nrepl#refresh#before "user.my/stop")
               (set nvim.g.conjure#client#clojure#nrepl#refresh#after "user.my/go"))
            {:bang true})
          ...
          (nvim.create_user_command
            :ClojureAutoReloadDev
            #(do
               (set nvim.g.conjure#client#clojure#nrepl#refresh#before "dev/stop")
